const Footer = () => {
  return (
    <div>
      <footer className="px-4 divide-y border-t bg-[#020043]">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3 mx-10 -mt-3">
            <a
            ...
            <p className="lg:text-left text-center lg:pr-5 text-white">
              123 Main Street Anytown, <br />
              USAPostal Code: 12345 <br />
          ...
          <div className="grid grid-cols-2 mx-auto text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                <p className="text-white">@Sanny 2024</p>
              </div>
            </div>
          </div>
        </div>
