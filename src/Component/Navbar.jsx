      ...
      <header className="mt-5">
        <div className="container flex justify-between h-16 mx-auto">
          ...
          <div className="items-center flex-shrink-0 hidden lg:flex">
            <button className="self-center rounded-2xl px-8 py-2 font-semibold border-black border-2 flex gap-1 items-center">
              Appointment <MdOutlineArrowOutward size={20} />
            </button>
          </div>
